...
const styles = StyleSheet.create({
  ...
  segmentBtn: { paddingVertical: 8, paddingHorizontal: 14, borderWidth: 1, borderColor: COLORS.border, borderRadius: 20, marginRight: 10, backgroundColor: COLORS.card },
  segmentActive: { backgroundColor: COLORS.primary },
  segmentText: { color: COLORS.text, fontWeight: '600' },
  segmentTextActive: { color: '#000' },
  vehiclePill: { paddingVertical: 8, paddingHorizontal: 12, borderRadius: 20, borderWidth: 1, borderColor: COLORS.border, marginRight: 8, backgroundColor: COLORS.card },
  ...
  filterPill: { paddingVertical: 8, paddingHorizontal: 12, borderRadius: 20, borderWidth: 1, borderColor: COLORS.border, marginRight: 8, backgroundColor: COLORS.card },
